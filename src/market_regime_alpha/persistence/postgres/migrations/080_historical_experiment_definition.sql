-- Phase E3 exact exploratory Experiment owner consumed before Scope materialization.
...
'Migration 080 adds the frozen exploratory Experiment owner consumed by longitudinal Historical Scope; it grants no qualification or Production authority.';
