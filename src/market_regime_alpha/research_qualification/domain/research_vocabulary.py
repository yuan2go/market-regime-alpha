...
class EvaluationSourceKind(StrEnum):
    ...
    EXPERIMENTAL_FORECAST_OUTCOME_PAIR = "EXPERIMENTAL_FORECAST_OUTCOME_PAIR"
    CANDIDATE_DISPOSITION = "CANDIDATE_DISPOSITION"
    SIGNAL_STATUS = "SIGNAL_STATUS"
    PORTFOLIO_LINE = "PORTFOLIO_LINE"
    PORTFOLIO_OUTCOME = "PORTFOLIO_OUTCOME"
    RISK_DECISION = "RISK_DECISION"
    CANDIDATE_OUTCOME_PAIR = "CANDIDATE_OUTCOME_PAIR"
...
class EvaluationSourceMeasure(StrEnum):
    ...
    CANDIDATE_SCORE_VS_TARGET = "CANDIDATE_SCORE_VS_TARGET"
    CANDIDATE_TOP_K_RETURN = "CANDIDATE_TOP_K_RETURN"
