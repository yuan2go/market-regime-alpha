...
class LifecycleObjectType(str, Enum):
    ...
    STATIC_UNIVERSE_FEATURE_BUNDLE = "STATIC_UNIVERSE_FEATURE_BUNDLE"
    CANDIDATE_INTRADAY_FEATURE_OVERLAY = "CANDIDATE_INTRADAY_FEATURE_OVERLAY"
    ...
    CONTROLLED_PLATFORM_RESEARCH_ARTIFACT = (
        "CONTROLLED_PLATFORM_RESEARCH_ARTIFACT"
    )
...
class LifecycleReaderKind(str, Enum):
    ...
    OPERATIONAL_UNIVERSE_READER = "OPERATIONAL_UNIVERSE_READER"
    STATIC_UNIVERSE_FEATURE_BUNDLE_READER = (
        "STATIC_UNIVERSE_FEATURE_BUNDLE_READER"
    )
    CANDIDATE_INTRADAY_FEATURE_OVERLAY_READER = (
        "CANDIDATE_INTRADAY_FEATURE_OVERLAY_READER"
    )
    ...
    CONTROLLED_PLATFORM_RESEARCH_ARTIFACT_READER = (
        "CONTROLLED_PLATFORM_RESEARCH_ARTIFACT_READER"
    )
