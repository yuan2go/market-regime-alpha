"""Scope-consistent competing-event diagnostics for MR-2B F2B v3."""
...
def build_competing_event_diagnostics_v3(
    *,
    ...
    return CompetingEventResultV3("AVAILABLE", COMPETING_EVENT_TARGET_ID, COMPETING_EVENT_RULE_ID, output, coverage)
