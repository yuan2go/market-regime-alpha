...
def _authorization(**overrides: object) -> StrategyExecutionAuthorization:
    values: dict[str, object] = {
        ...
        "account_reconciliation_reference": _reference("ACCOUNT_RECONCILIATION", "reconciliation"),
        "trading_calendar_reference": _reference("TRADING_CALENDAR", "calendar"),
        "price_reference": _reference("CANONICAL_MARKET_BAR", "price-bar"),
        "price_source_reference": _reference("MARKET_DATA_DATASET", "price-dataset"),
