...
def _fault_qualification(app, spec, source_id, database_url):
    ...
    from tests.refoundation.outcome.test_outcome_postgres import _outcome_claim
    from tests.refoundation.research_qualification.test_evaluation_closure_postgres import _CommitAckLostOnce
