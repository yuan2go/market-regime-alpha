...
from tests.contracts.formal_research import test_formal_campaign_postgres as _formal
...
def backtest_stack(target_database_url, tmp_path, request):
    return _formal.formal_campaign_stack.__wrapped__(target_database_url, tmp_path, request)
