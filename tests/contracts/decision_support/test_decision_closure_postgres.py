...
from tests.contracts.decision_support.test_decision_domain import _uuid
from tests.contracts.decision_support.test_decision_closure_domain import _portfolio_policy, _risk_policy
from tests.contracts.decision_support import test_strategy_inference_postgres as _inference
from tests.contracts.decision_support.test_strategy_inference_postgres import (
    _binding,
    _context_policy,
    _open_decision,
...
from tests.contracts.selection import test_candidate_vertical_slice_postgres as _candidate
...
@pytest.fixture
def decision_closure_stack(target_database_url, tmp_path, request):
    return _inference.wp13_inference_stack.__wrapped__(target_database_url, tmp_path, request)


def test_postgres_closes_opportunity_thesis_portfolio_and_risk(decision_closure_stack) -> None:
    stack = decision_closure_stack
    runtime, decision = _open_decision(stack)
    context_policy = _context_policy(stack, decision.decision_run_id, runtime)
    strategy = _registered_strategy(stack, decision.decision_run_id, context_policy)
    InferenceCommands(
...
def test_stale_fence_writes_no_opportunity_or_failure_authority(decision_closure_stack) -> None:
    stack = decision_closure_stack
...
def test_changed_opportunity_requests_race_to_one_truth(decision_closure_stack) -> None:
    stack = decision_closure_stack
...
def test_mid_opportunity_failure_leaves_no_partial_roster(decision_closure_stack) -> None:
    stack = decision_closure_stack
...
def test_mid_portfolio_failure_leaves_no_partial_roster(decision_closure_stack) -> None:
    stack = decision_closure_stack
...
def test_mid_risk_failure_leaves_no_partial_cartesian_roster(decision_closure_stack) -> None:
    stack = decision_closure_stack
