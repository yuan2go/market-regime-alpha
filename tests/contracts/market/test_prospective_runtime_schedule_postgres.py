...
from tests.contracts.market.test_prospective_runtime_plan import _manifest
...
def test_continuation_keeps_the_registered_schedule_revision(
    ...
    from tests.contracts.market.test_prospective_archive_planner import _contract, _manifest as target_manifest
    from tests.contracts.market.test_prospective_continuity import _calendar
...
def test_prospective_predeclare_and_due_capture_use_exact_runtime_fences(
    ...
    from tests.contracts.market.test_runtime_vertical_slice import _capture_step, _schedule_run
