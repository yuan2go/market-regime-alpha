#!/usr/bin/env python3
"""Run the immutable coverage-first MR-2B F2B v2 closure."""
...
from market_regime_alpha.research.mr2b_f2b_v2_artifacts import run_f2b_v2_research
