...
|---|---|---|---|
| [WP-D0](work-packages/WP-D0-Platform-Governance-Kernel.md) | Platform Governance Kernel | current minimum-hardened Platform Kernel, completed post-consolidation audit and Daily contract-convergence decision | durable Model Registry and Experiment Governance authority with explicit recovery/concurrency behavior and compatibility with immutable PredictionRuns |
