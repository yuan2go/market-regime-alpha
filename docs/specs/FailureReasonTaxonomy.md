...
> **Authority:** Phase D contract specification: Versioned hierarchical failure reason definitions  
> **Owner:** Review/Governance domain  
...
> **Code Evidence:** DESIGNED_ONLY unless stated below
    ...
    Versioned hierarchical failure reason definitions.

    ## Owner and authority

    Owner: Review/Governance domain. This object is the authoritative record for its bounded purpose only. It does not assume responsibilities owned by adjacent domains.
...
- `severity`
    ...
    1. One primary cause may coexist with contributing causes.
2. UNCLASSIFIED is valid when evidence is insufficient.
