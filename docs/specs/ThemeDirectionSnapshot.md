...
> **Authority:** Phase D contract specification: PIT theme mapping, breadth, leaders and deterioration  
...
> **Code Evidence:** DESIGNED_ONLY unless stated below
    ...
    PIT theme mapping, breadth, leaders and deterioration.

    ## Owner and authority

    Owner: Theme Direction domain. This object is the authoritative record for its bounded purpose only. It does not assume responsibilities owned by adjacent domains.
...
- `content_hash`
    ...
    1. Theme membership is time-versioned or explicitly unavailable.
2. Narrative labels do not replace measurable evidence.
