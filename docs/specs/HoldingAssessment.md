...
> **Authority:** Phase D contract specification: Assess continuation, add, reduce or rotate for a position  
...
> **Code Evidence:** DESIGNED_ONLY unless stated below
    ...
    Assess continuation, add, reduce or rotate for a position.
...
- `expires_at`
    ...
    1. Actions are HOLD/ADD/REDUCE/ROTATE/EXIT/NO_ACTION.
2. NO_ACTION is not HOLD.
3. ADD requires portfolio/risk approval.
