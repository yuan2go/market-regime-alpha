...
| Conditional Forecast outputs calibrated probability or qualified Strategy action | False: barrier heads emit raw logits/frequencies, calibration is absent and Strategy economics were not run | `ENGINEERING_WIRED / CALIBRATED=false / STRATEGY_QUALIFIED=false` |
