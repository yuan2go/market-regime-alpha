...
| WP-PREDICTION-01 engineering | Empirical/regularized Forecast comparison with sample availability/minimum/uncertainty; Strategy Contract V2 and conditional consumer bind Signal/Forecast/Context/Risk/Model lineage and fail closed when required | `ENGINEERING_WIRED / RESEARCH_READY`; calibration, economics, Formal OOS and qualification remain false |
