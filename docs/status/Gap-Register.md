...
| Pre-Strategy Risk/Opportunity production | Shared semantics bind typed Account/Reconciliation, Position/symbol/theme exposure, liquidity, restriction, available quantity and configured Risk limits; Continuous and Historical produce/reload exact Risk/Opportunity when explicitly bound, and both fail closed on unavailable facts | Conditional Strategy economics and admission evidence are `NOT_RUN` |
