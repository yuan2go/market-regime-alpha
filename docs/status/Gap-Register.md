...
| Broader historical context and cross-section | one frozen 2023-2025 real corpus completes 667 sessions with interruption recovery and exact replay, but only six liquid stocks are observed; ETF/Capital/Candidate/Signal/Forecast, Market Cap and Industry effects are not estimable | a separately frozen broader corpus supplies real ETF/index and historical listing/ST/suspension/market-cap/industry facts without substitution, leakage or tuning, then replays the same Protocol |
