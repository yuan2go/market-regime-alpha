...
| Operational Research Bridge | P1 | DailyLoop and PlatformResearchRunner remain independent; no canonical operational adapter | verified daily evidence plus typed market/theme/capital observations | verified Daily Artifact or Archive produces deterministic ResearchInputBundle and ResearchLayerArtifact without authority inflation |
