...
| WP-PREDICTION-01 engineering | Existing PathForecast baseline plus regularized comparison with exact sample availability/lineage/minimum/uncertainty; incumbent V1 Strategy identities remain stable and the conditional V2 consumer binds Signal/Forecast/Context/Risk/Model lineage | `ENGINEERING_WIRED / RESEARCH_READY`; calibration, economics, Formal OOS and qualification remain false |
