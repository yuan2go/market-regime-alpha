...
| Legacy Strategy/Portfolio simulation convergence | canonical multi-family seam is installed; older T+1 Strategy Shadow and Portfolio Shadow still serve active settlement/qualification consumers | consumer inventory and differential replay prove which compatibility writers can be migrated or removed without rewriting history |
