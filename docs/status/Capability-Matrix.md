...
| Minute / Signal / PathForecast | Implemented mechanics | exploratory and uncalibrated |
...
| Research Shadow | Implemented | frozen decision and factual outcome lineage |
...
| Strategy Shadow | Implemented | simulated ledger; no real mutation |
