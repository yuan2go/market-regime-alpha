...
> **Code Evidence:** Canonical Feature Spine implementation/gate checkpoint `72c8ed940d8b9d43788d6f2898ab081dc98bdc10`; canonical runtime merge baseline `9ccc751`; H4.5 checkpoint `b1d6533a0b3b1bbd9e180c7f6864b3be8dbd2254`; H6 checkpoint `654e025b97c5d9553d7614b4b5be0898272aacbc`
...
| Signal Feature input V2 | IMPLEMENTED_RESEARCH_ONLY_LOCAL_GATE_VERIFIED | `signals/input_assembly.py`, `signals/v2.py`, canonical Signal stage | Five-factor scope/freshness/missingness/lineage, Journal receipt, recomputation replay and full gate | Non-empty factors are not predictive evidence or Entry | Parameters not validated | Add incremental-value and OOS validation |
