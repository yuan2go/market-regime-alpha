...
| Generic real campaign/report/replay | New canonical archive has 116 actual sessions and 534 captures; frozen 44-session/four-arm campaign is in progress | Reconciled archive Authority with at least 40 actual sessions and 32 deterministic symbols; freeze four arms and two FIT→VALIDATION dependencies before reading validation Outcomes |
