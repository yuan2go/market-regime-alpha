...
line. Universe/Eligibility/Candidate is technically dependency-ready. This is
`GO` only for a separately authorized next work package; it is not
authorization to start that stage here and is not a Runtime/CLI cutover or
