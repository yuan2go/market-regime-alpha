...
| Fresh generic two-arm gate | Fresh two-arm Run completes all 25 actions, actual Model and six Evaluations; canonical replay and lineage match, repaired report publication succeeds; all prior failed Runs are retained | Finish the full table/Artifact identity and exact completed-resume/report-byte proof before starting the unchanged-parameter 44-session campaign |
