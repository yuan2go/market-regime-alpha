...
|---|---|---|
| Full exact-SHA engineering regression | Clean `c7df943c`: 3,992 tests and four subtests PASS; subsequent comparison correction has a separate full regression in progress; no inherited PASS | Locked environment, all tests/static/build/docs/import gates without skip/xfail or relaxed assertions |
