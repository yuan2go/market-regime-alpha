...
| [Research Artifact](domains/14-Research-Artifact.md) | Own immutable experiment, model, target, run, outcome, evaluation and promotion identities. | ExperimentIdentity, ModelDefinition, TargetDefinition, EvaluationProtocol, ResearchArtifact, PromotionDecision | `research/**`, `platform/**`, `evidence/**`; SQLite governance adapters and later-layer immutable packages | PostgreSQL parity, operating deployment and promotion integration |
